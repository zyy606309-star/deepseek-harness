...
export const en = {
  ...
  reasoningEffortPlaceholder: 'Uses the provider default',
  reasoningEffortOff: 'Off',
  reasoningEffortLow: 'Low',
  reasoningEffortHigh: 'High',
  reasoningEffortMax: 'Max',
  modelReasoningEffortInvalid: 'Thinking intensity must be off, low, high, or max.',
  modelImageSupport: 'Supports images',
  modelImageSupportInvalid: 'Image support must use text/image modalities.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  reasoningEffortPlaceholder: '使用提供方默认值',
  reasoningEffortOff: '关闭',
  reasoningEffortLow: '低',
  reasoningEffortHigh: '高',
  reasoningEffortMax: '最高',
  modelReasoningEffortInvalid: '思考强度必须为 off、low、high 或 max 之一。',
  modelImageSupport: '支持图片',
  modelImageSupportInvalid: '图片能力只能使用 text/image 模态。',
