...
```bash
python3 /path/to/skill/scripts/install_skill_tools.py /path/to/project --with-inp
python3 /path/to/skill/scripts/install_skill_tools.py /path/to/project --install-ida-plugin --ida-root /path/to/ida-pro
python3 /path/to/skill/scripts/install_skill_tools.py /path/to/project --ida-plugin-dir /path/to/ida-pro/plugins
```
