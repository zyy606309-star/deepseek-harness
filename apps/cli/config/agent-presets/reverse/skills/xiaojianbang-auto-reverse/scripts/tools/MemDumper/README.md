...
## How to use
- This Skill distribution keeps only the precompiled Android binaries under `libs/`.
...
## Source and Build
- Native source files are not included in this Skill distribution.
- To rebuild MemDumper, use the upstream source package and then replace the binaries under `libs/`.
